...
class BlueTscPrinter {
  ...
  static BlueTscPrinter _instance = new BlueTscPrinter._();

  static BlueTscPrinter get instance => _instance;
  ...
  ///printBarcode(String textToBar, int width, int height)
  Future<dynamic> printBarcode(
          String textToBar, int width, int height) =>
